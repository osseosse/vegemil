...
(function($){
	...
	$.fn.slides.option = {
		...
		fadeSpeed: 1500, // number, Set the speed of the fading animation in milliseconds
		slideSpeed: 1500, // number, Set the speed of the sliding animation in milliseconds
