! function(e, t) {
    ...
    function(e, t) {
        ...
        }(t), e.Util = Et, e.Alert = Tt, e.Button = Ct, e.Carousel = xt, e.Collapse = At, e.Dropdown = St, ! function(e, t) {
                "object" == typeof module && "object" == typeof module.exports ? module.exports = e.document ? t(e, !0) : function(e) {
                    if (!e.document) throw new Error("jQuery requires a window with a document");
                    return t(e)
                } : t(e)
        ...
        e.Modal = Nt, e.Popover = kt, e.Scrollspy = It, e.Tab = Ot, e.Tooltip = Dt, Object.defineProperty(e, "__esModule", {
            value: !0
        })
    });