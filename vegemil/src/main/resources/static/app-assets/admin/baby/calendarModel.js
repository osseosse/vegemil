      ...
      columnDefs: [
        ...
        },
		{
          ...
          render: function (data, type, full, meta) {
			  ...
			  var imgSrc = full['cImage'].startsWith('http') ? full['cImage'] : 'https://image.edaymall.com/images/vegemil-upload/vegemilBaby/'+full['cImage'];
      		  return '<img src="'+imgSrc+'?v='+Date.now()+'" height="40" width="40" class="rounded">';
          }
        },
        {
      		targets: 11,
          ...
          buttons: [
            {
              ...
              exportOptions: { columns: [0, 2, 4, 5, 6, 7, 8, 9, 11, 12, 13] }
            },
            {
              extend: 'csv',
...
function getModal(obj) {	
	...
	modal +=													'<p class="mt-1"><img class="imageToRotate1'+obj.cIdx+'" src="'+(obj.cImage.startsWith('http') ? obj.cImage : 'https://image.edaymall.com/images/vegemil-upload/vegemilBaby/'+obj.cImage)+'?v='+Date.now()+'" width="100%"/></p>'
	modal +=												'</div>'
	modal +=											'</div>'
	modal +=										'</dd>'
												}
	...
	modal +=													'<p class="mt-1"><img class="imageToRotate2'+obj.cIdx+'" src="'+(obj.cImage2.startsWith('http') ? obj.cImage2 : 'https://image.edaymall.com/images/vegemil-upload/vegemilBaby/'+obj.cImage2)+'?v='+Date.now()+'" width="100%"/></p>'
