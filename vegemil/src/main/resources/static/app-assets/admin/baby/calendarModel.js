...
function getModal(obj) {	
	...
	modal +=													'<p class="mt-1"><img class="imageToRotate1'+obj.cIdx+'" src="'+(obj.cImage.startsWith('http') ? obj.cImage : 'https://image.edaymall.com/images/vegemil-upload/vegemilBaby/'+obj.cImage)+'" width="100%"/></p>'
	modal +=												'</div>'
	modal +=											'</div>'
	modal +=										'</dd>'
												}
	...
	modal +=													'<p class="mt-1"><img class="imageToRotate2'+obj.cIdx+'" src="'+(obj.cImage2.startsWith('http') ? obj.cImage2 : 'https://image.edaymall.com/images/vegemil-upload/vegemilBaby/'+obj.cImage2)+'" width="100%"/></p>'
