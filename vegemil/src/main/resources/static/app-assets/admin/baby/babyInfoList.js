    ...
    var dt_basic = dt_basic_table.DataTable({
      ...
      columnDefs: [
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              '<button type="button" class="btn btn-primary btn-sm btn-sm waves-effect waves-float waves-light" onclick="location.href = \'babyInfoAdd?mbsIdx='+full['mbsIdx']+ '\'">수정</button>'
            );
          }
			...
			let mbsCategory;
      	    if(full['mbsCategory'] == 'pb') {
				if(full['mbsMCategory'] == 'pb01'){
					...
					mbsCategory = '임신기 건강관리'
				}else if(full['mbsMCategory'] == 'pb05'){
					mbsCategory = '임신 준비&태교'
				}else if(full['mbsMCategory'] == 'pb06'){
					mbsCategory = '출산 준비&용품'
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            if(full['mbsImage']==null)	return '-';
      			else	return '<img src="https://image.edaymall.com/images/vegemil-upload/vegemilBaby/babyInfo/thumbnail/'+full['mbsImage']+  '" height="60" width="100" class="rounded">';
          }
        },
        {
          targets: 8,
