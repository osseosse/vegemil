...
var createTable = function() {
  ...
  if (dt_basic_table.length) {
    ...
    var dt_basic = dt_basic_table.DataTable({
	  ...
	  processing: true,
      ajax: {
        url : '/admin/manage/customer/memberList',
        dataType : 'json',
      ...
      columnDefs: [
        ...
        },
        {
          ...
          orderable: false,
          render: function (data, type, full, meta) {
            return full['mAddr1'] + ' ' + full['mAddr2'];
          }
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              '<button type="button" class="btn btn-primary btn-sm btn-sm waves-effect waves-float waves-light" onclick="location.href = \'memberDetail?mIdx='+full['mIdx']+ '\'">수정</button>'
            );
          }
        ...
        },
        {
          ...
          render: function (data, type, full, meta) {
            return (
              '<button type="button" class="btn btn-primary btn-sm btn-sm waves-effect waves-float waves-light" onclick="btnSave('+full['mIdx']+',\'D\')">탈퇴</button>'
            );
          }
