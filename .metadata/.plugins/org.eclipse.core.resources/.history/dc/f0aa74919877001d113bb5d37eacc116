...
import com.vegemil.service.greenbia.GreenbiaProductService;
...
public class GreenbiaProductController {
	...
	public String newProduct(Model model, @RequestParam(required = false) String category) {
	...
	public String search(Model model, String searchKeyword) {
